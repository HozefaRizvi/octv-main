...
import {fetcPaginationAdvisoryData} from '../../services/axios/apiManager';
import {useRoute, useNavigation} from '@react-navigation/native';
import {getNextPageByAdvisory, getStreamsByAdvisory} from './homeStore';
...
const Advisory = () => {
  ...
  useEffect(() => {
    getStreamsByAdvisory(id, setQdata, setStreams, setLoading, setMeta);
  }, [id]);
