...
import {getNextPageByYear, getStreamsByYear} from './homeStore';
const MultiObjects = () => {
  ...
  useEffect(() => {
    getStreamsByYear(id, setMovies, setLoading, setMeta);
  }, [id]);
  ...
  return (
    <View style={[styles.container,{ backgroundColor: colors.black,}]}>
      <SafeAreaView style={styles.safeArea}>
        ...
        <Text style={[styles.headerText,{color: colors.white,}]}>{id || ''}</Text>
        </TouchableOpacity>
        {loading && (
